                ...
                <div className="max-w-full mx-auto mt-10 md:mt-15 py-10 md:py-20">
                    ...
                    <div className="flex flex-col lg:flex-row gap-16 items-start">
                        {/* LEFT SIDE: Information */}
                            ...
                            >
                                <h2 className="text-3xl md:text-5xl font-bold text-gray-700 mb-6">Connect With US</h2>
                                ...
                                <div className="space-y-10">
                                        {contacts.map((item, i) => (
                                            ...
                                            >
                                                ...
                                                <p className="text-slate-600 font-medium">{item.val}</p>
                            ...
                            <div  className="lg:w-7/12 w-full bg-[#DCDCDC]/25 p-8 md:p-14 rounded-2xl border border-blue-200 shadow-[0_20px_60px_rgba(0,0,0,0.06)]">
                                ...
                                >
                                    <h3 className="text-2xl md:text-3xl font-bold text-gray-700 mb-10">Schedule Your Consultation</h3>
                                    ...
                                    <form className="space-y-8">
                                        ...
                                        <div className="space-y-3">
                                            <label className="text-sm font-bold text-slate-700 ml-1 uppercase tracking-wider">Company</label>
                                        ...
                                        <div className="space-y-3">
                                        <label className="text-sm font-bold text-slate-700 ml-1 uppercase tracking-wider">Project Description *</label>
