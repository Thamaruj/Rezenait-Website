...
export default function services(){
    return(
        <>
            ...
            <main className='text-center mx-w-full pt-10 mx-5  md:pt-20'>   
                <div>
                    <motion.h1 
                ...
                <div className="bg-[#DCDCDC]/25 md:py-15 py-10 md:mx-10 rounded-xl">
                        ...
                        {/* Card 1 */}
                            <div className="rounded-xl bg-white p-8 w-full shadow-lg hover:scale-[1.02] transition-all duration-300 ease-out border border-blue-600">
                               <img src="/Icons/BrainIcon.svg" alt="AI Icon " className='mb-5'  />
                                <h3 className="text-2xl  text-gray-700 text-bold text-start">AI/ML Engineering</h3>
                            ...
                            <div className="rounded-xl bg-white p-8 w-full shadow-lg hover:scale-[1.02] transition-all duration-300 ease-out border border-blue-600">
                               <img src="/Icons/DatabaseIcon.svg" alt="AI Icon " className='mb-5'  />
                                <h3 className="text-2xl text-gray-700 text-bold text-start">Data & Strategy Engineering</h3>
                            ...
                            <div className="rounded-xl bg-white p-8 w-full shadow-lg hover:scale-[1.02] transition-all duration-300 ease-out border border-blue-600">
                               <img src="/Icons/AnalyticsIcon.svg" alt="AI Icon " className='mb-5'  />
                                <h3 className="text-2xl  text-gray-700 text-bold text-start">Analytics & BI</h3>
                                <p className="mt-4 text-gray-700 text-start font-light md:mb-5">
